<nav class="bg-gray-800">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-20 h-r items-center justify-between">
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-middle space-x-4 ">
            <!-- Current: "", Default: "" -->
      ...
      <div class="hidden md:block">
        <div class="ml-4 flex place-items-center  md:ml-6 ">
          <button type="button"
        ...
        <?php else: ?>
          <div class="ml-3 ">
            ...
            <a href="/register"
               class="text-gray-400 bg-gray-700 hover:bg-gray-600 text-white rounded-md px-3 py-2 text-sm font-medium ">Register</a>
            <a href="/login"
